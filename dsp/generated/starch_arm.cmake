...
set_source_files_properties(dsp/generated/flavor.armv7a_neon_vfpv4.c PROPERTIES COMPILE_OPTIONS "-march=armv7-a+neon-vfpv4;-mfpu=neon-vfpv4;-ffast-math")

set_source_files_properties(dsp/generated/flavor.generic.c PROPERTIES COMPILE_OPTIONS "")

macro(add_starch_library target)
  add_library(${target} ${ARGN} dsp/generated/flavor.armv7a_neon_vfpv4.c dsp/generated/flavor.generic.c dsp/generated/dispatcher.c)
  target_include_directories(${target} PRIVATE "dsp/generated")
  target_compile_definitions(${target} PUBLIC "STARCH_MIX_ARM")
endmacro()

macro(add_starch_benchmark target starchlib)
  add_executable(${target} ${ARGN} dsp/generated/benchmark.c)
